...
@section('content')
  ...
  ">
            <div class="text-center fluid ">
                ...
                <a href="/blog" class=" text-decoration-none fs-3  ">Start Reading</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <p>
                    ...
                    Plant native species and be kind to all the insects and birds that feed on flower nectar and pollinate
                    the fruits.
                    If you can, support local wildlife around your home by setting up bee hotels, bird boxes, ponds and
                    green
                </p>
        ...
        <div>
            ...
            <div class="container">
                ...
                <div class="row mb-2">
                    ...
                    <img class="col-md-4" src="https://picsum.photos/id/778/960/620" alt="">
                </div>
                ...
                <div class="row">
                    ...
                    <img class="col-md-4" src="https://picsum.photos/id/9/960/620" alt="">
                </div>
            </div>
        </div>
        <hr>
        <div class="row">
            <img class="col-md-4" src="https://picsum.photos/id/900/960/620" alt="">

            <img class="col-md-4" src="https://picsum.photos/id/600/960/620" alt="">

            <img class="col-md-4" src="https://picsum.photos/id/200/960/620" alt="">
        </div>
        <hr>
    @endsection
